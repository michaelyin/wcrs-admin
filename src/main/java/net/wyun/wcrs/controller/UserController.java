...
import net.wyun.wcrs.security.SecurityService;
import net.wyun.wcrs.security.UserService;
import net.wyun.wcrs.security.UserValidator;
...
public class UserController {
    ...
    public String registration(@ModelAttribute("userForm") Account userForm, BindingResult bindingResult, Model model) {
        ...
        //return "redirect:/op-insert.html";
    }
